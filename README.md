...
# 📖 [Review of the project from trials] <a name="about-project"></a>

**[Review of the project from trials]** is a microverse project for the project review practice
...
I would like to thank Microverse for this opportunity of code reviewing project
